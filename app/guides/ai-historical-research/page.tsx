...
import { Lightbulb, AlertCircle, CheckCircle, ExternalLink, BookOpen, FileText, Search } from 'lucide-react'

const tableOfContents = [
  { id: 'intro', title: 'Introduction' },
  { id: 'landscape', title: 'The Current Landscape' },
  { id: 'notebooklm', title: 'Google NotebookLM' },
  { id: 'research-tools', title: 'Research Synthesis Tools' },
  { id: 'document-analysis', title: 'Document Analysis & OCR' },
  { id: 'workflows', title: 'Practical Workflows' },
  { id: 'prompts', title: 'Prompt Library' },
  { id: 'limitations', title: 'Limitations & Ethics' },
...
export default function AIHistoricalResearchGuide() {
  ...
  return (
    <GuideLayout
      ...
      subtitle="A comprehensive guide to using AI tools for document analysis, literature synthesis, translation, and historical research workflows"
    ...
    >
      ...
      <p>
        This guide draws on work by <WikiLink term="Steven Johnson (author)">Steven Johnson</WikiLink> (co-creator of Google NotebookLM), recent advances in historical document recognition, and practical experience from historians using AI in 2024-2025. We'll examine specific tools, provide tested prompts, and outline workflows that maintain scholarly standards while leveraging AI capabilities.
      </p>
        ...
        <table className="w-full border-collapse border border-slate-300 dark:border-slate-700">
          ...
          <tbody className="text-sm">
            ...
            <tr>
              ...
              <td className="border border-slate-300 dark:border-slate-700 px-4 py-2"><WikiLink term="Optical character recognition">OCR</WikiLink>, transcription, translation</td>
              <td className="border border-slate-300 dark:border-slate-700 px-4 py-2">Claude 3.5, ChatGPT-4o, Transkribus</td>
            ...
            <tr>
              ...
              <td className="border border-slate-300 dark:border-slate-700 px-4 py-2">Extracting data from <WikiLink term="Historical geography">historical maps</WikiLink></td>
            ...
            <tr>
              ...
              <td className="border border-slate-300 dark:border-slate-700 px-4 py-2">GPT-4, Claude 3.5</td>
              <td className="border border-slate-300 dark:border-slate-700 px-4 py-2">Large <WikiLink term="Text corpus">corpora</WikiLink>, computational text analysis</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <p>
        <WikiLink term="Steven Johnson (author)">Steven Johnson</WikiLink>, NotebookLM's Editorial Director and author of 14 books (including the Edgar-winning <em>The Infernal Machine</em>), uses NotebookLM extensively for historical research. His approach offers lessons for historians:
      </p>
      ...
      <p>
        Johnson used NotebookLM while researching the <WikiLink term="California Gold Rush">California Gold Rush</WikiLink>, maintaining a collection of over 7,000 quotes from 20+ years of research. He could instantly find specific facts or quotes with natural language queries—work that would otherwise require hours of manual searching.
      </p>
        ...
        <div className="flex gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-emerald-900/80 dark:text-emerald-100/80 mb-0">
              Because NotebookLM works only with your sources, you avoid the <WikiLink term="Hallucination (artificial intelligence)">hallucination</WikiLink> problem that plagues general-purpose AI. If NotebookLM says something is in a source, you can check. This makes it far more trustworthy for scholarly work than asking ChatGPT about historical topics it may misremember or confabulate.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="my-6 space-y-4">
        <div className="p-5 bg-slate-50 dark:bg-slate-900 rounded-lg border">
          ...
          <p className="text-sm mb-3">
            <strong>Task:</strong> You've collected 30 <WikiLink term="American Civil War">Civil War</WikiLink> diaries and want to identify common themes about soldiers' experiences.
          </p>
        ...
        <div className="p-5 bg-slate-50 dark:bg-slate-900 rounded-lg border">
          ...
          <p className="text-sm mb-3">
            <strong>Task:</strong> Understanding how historians have interpreted the causes of the <WikiLink term="French Revolution">French Revolution</WikiLink> over the past 50 years.
          </p>
          <p className="text-sm text-muted-foreground mb-0">
            <strong>Approach:</strong> Upload 20-30 key articles and book chapters. Ask: "How have explanations for the French Revolution's causes changed over time? What are the major schools of thought?" NotebookLM can map the <WikiLink term="Historiography">historiographical</WikiLink> landscape with specific citations.
          </p>
        </div>
        ...
        <div className="p-5 bg-slate-50 dark:bg-slate-900 rounded-lg border">
          ...
          <p className="text-sm mb-3">
            <strong>Task:</strong> Comparing how two historical figures (<WikiLink term="Frederick Douglass">Frederick Douglass</WikiLink> and <WikiLink term="William Lloyd Garrison">William Lloyd Garrison</WikiLink>) discussed abolition.
          </p>
          <p className="text-sm text-muted-foreground mb-0">
      ...
      <p>
        <strong>Limitations for historians:</strong> Elicit works best with quantitative studies that have clear methods/findings sections. Interpretive historical scholarship may not be well-represented in the extracted summaries. It's excellent for finding empirical studies (e.g., <WikiLink term="Demographic history">demographic history</WikiLink>, <WikiLink term="Economic history">economic history</WikiLink>) but less useful for cultural or <WikiLink term="Intellectual history">intellectual history</WikiLink>.
      </p>
      ...
      <ul>
        <li>"Did climate change contribute to the <WikiLink term="Fall of the Western Roman Empire">fall of the Roman Empire</WikiLink>?" → Shows distribution of scholarly opinion</li>
        <li>"Was the <WikiLink term="Black Death">Black Death</WikiLink> caused by <WikiLink term="Bubonic plague">bubonic plague</WikiLink>?" → Maps the debate with citations</li>
      </ul>
        ...
        <div className="flex gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-orange-900/80 dark:text-orange-100/80 mb-0">
              "Consensus" doesn't mean "truth"—it means scholarly agreement at a moment in time. Historical scholarship evolves, and minority positions sometimes overturn established consensus. Use these tools to understand the field, not as arbiters of historical fact.
            </p>
          </div>
        </div>
      </div>
      ...
      <h3 className="font-sans text-xl font-semibold mt-8 mb-4">Breakthrough: Historical Text Recognition</h3>

      <p>
        Research from 2024-2025 has demonstrated that specialized AI models trained on historical documents significantly outperform general-purpose tools. Domain-specific training on historical materials produces far better results than using ChatGPT or Claude with zero training on <WikiLink term="Paleography">paleographic</WikiLink> materials.
      </p>

      <div className="my-6 p-5 bg-slate-50 dark:bg-slate-900 rounded-lg border">
        <h4 className="font-sans text-base font-semibold mt-0 mb-3">Currently Available Tools</h4>
        <ul className="text-sm space-y-1 mb-0 pl-5">
          ...
          <li><strong><WikiLink term="Transkribus">Transkribus</WikiLink>:</strong> Specialized tool for large-scale transcription projects, trained on specific scripts</li>
        </ul>
      </div>
...
[Paste original text or upload image]`}</code></pre>
            ...
            <div className="bg-slate-100 dark:bg-slate-800 p-4 rounded-md text-xs">
              ...
              <ul className="text-xs space-y-1 pl-4 list-disc">
                ...
                <li>"grain levy" - refers to forced contributions during times of shortage</li>
        ...
        <ol className="text-sm space-y-3 mb-0 pl-5">
          ...
          <li>
            ...
            <ul className="mt-2 space-y-1 pl-4 list-disc">
              ...
              <li>Create <WikiLink term="Metadata">metadata</WikiLink> file (date, sender, recipient, location)</li>
      ...
      <div className="my-6 p-5 bg-slate-50 dark:bg-slate-900 rounded-lg border">
        <h4 className="font-sans text-base font-semibold mt-0 mb-4">Scenario: Comparing French and German sources on <WikiLink term="World War I">WWI</WikiLink></h4>
        <ol className="text-sm space-y-3 mb-0 pl-5">
          <li>
          ...
          <li>
            <strong>Comparative Questions:</strong> "How do French sources describe the <WikiLink term="Battle of Verdun">Battle of Verdun</WikiLink> compared to German sources?" "What terms do each use for the enemy?"
          </li>
          <li>
...
[Paste document excerpt]`}</code></pre>
      ...
      <div className="my-6 space-y-4">
        ...
        <div className="p-5 bg-orange-50 dark:bg-orange-950/20 rounded-lg border border-orange-200 dark:border-orange-800">
          ...
          <p className="text-sm text-orange-900/80 dark:text-orange-100/80 mb-0">
            AI models trained on historical texts may reproduce historical biases—racism, sexism, <WikiLink term="Colonialism">colonialism</WikiLink>—embedded in those texts. Be especially careful when analyzing sources about marginalized groups. AI might perpetuate rather than critique oppressive perspectives.
          </p>
        </div>
      ...
      <ul>
        ...
        <li><strong>Domain-specific models:</strong> More tools trained specifically on historical materials from particular periods/languages</li>
        <li><strong>Improved handwriting recognition:</strong> Continued advances in reading <WikiLink term="Cursive">cursive</WikiLink>, damaged documents, and unusual scripts</li>
      ...
      <ul>
        ...
        <li><strong>Historical imagination:</strong> Understanding what it was like to live in a different time requires <WikiLink term="Historical empathy">empathy</WikiLink> and contextual knowledge AI lacks</li>
        ...
        <li><strong>Archival discovery:</strong> Finding unexpected connections, recognizing significance in overlooked sources—<WikiLink term="Serendipity">serendipity</WikiLink> and intuition remain human strengths</li>
      </ul>
